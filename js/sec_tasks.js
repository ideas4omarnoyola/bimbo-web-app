     ...
     switch (cualTool) {
         ...
         case "Distribution_Agreement":
             ...
             Swal.fire({
                 ...
                 html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v5.9/docs/web/Distribution_Agreement468.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Classroom Day":
             ...
             Swal.fire({
                 title: 'Classroom Day',
                 html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v5.9/docs/web/Classroom_Day.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Handheld_(HHC)":
             ...
             Swal.fire({
                 title: 'Handheld (HHC)',
                 html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v5.9/docs/web/Handheld_(HHC).pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Safe_Carry_Over_(SCO)":
             ...
             Swal.fire({
                 title: 'ION Intelligent Ordering Network',
                 html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v5.9/docs/web/Safe_Carry_Over_(SCO).pdf&embedded=true" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Settlement":
             ...
             Swal.fire({
                 title: 'ION Intelligent Ordering Network',
                 html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v5.9/docs/web/Settlement.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Aramark Order Form":
             ...
             Swal.fire({
                 title: 'ION Intelligent Ordering Network',
                 html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v5.9/docs/web/Aramark_Clothing_Options_and_Order_Form.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
