        ...
        switch (cualTool) {
            case 1:
                ...
                Swal.fire({
                    ...
                    html: '<iframe id="pdfFrame" src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/Aramark_Clothing_Options_and_Order_Form.pdf&embedded=true" style="min-height:80vh; width:100%"></iframe>',
            ...
            case 2:
                ...
                Swal.fire({
                    ...
                    html: '<iframe id="pdfFrame" src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/Distribution_Agreement468.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: false,
                    width: '100%',
            ...
            case 3:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/ION Introduction.pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            //     // window.open('http://docs.google.com/viewer?url=' + laURL + 'docs/ION_SetUp.pdf');
                Swal.fire({
                    title: 'Classroom Day',
                    html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/Classroom_Day.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 24:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/Safe_Carry_Over_(SCO).pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 25:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/Scan_Based_Trading_(SBT)_Introduction.pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 26:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/Scan_Based_Trading_(SBT).pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 27:
                ...
                Swal.fire({
                    title: 'Settlement',
                    html: '<iframe src="http://docs.google.com/gview?url=https://revisioni4l.mx/revision/appweb/Onboarding_v6/docs/Settlement.pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
